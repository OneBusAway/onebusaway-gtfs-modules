...
/**
 * An extension of the two-member {@link T2} tuple type where both members of the
 * tuple are of the same type. See {@link Tuples#pair(Object, Object)} for a
 * factory method to create a Pair object.
 * 
 * @author bdferris
...
public interface Pair<T> extends T2<T, T> {
  ...
  /**
   * @return a Pair whose members are equal to this pair's, but have been
   *         swapped in order
   */
  public Pair<T> swap();
}