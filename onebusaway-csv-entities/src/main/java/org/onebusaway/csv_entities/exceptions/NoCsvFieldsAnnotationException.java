...
/**
 * Indicates that an entity type was passed to {@link AnnotationDrivenEntitySchemaFactory} for
 * introspection and the specified entity type did not have a {@link CsvFields} class annotation
 *
 * @author bdferris
 * @see CsvFields
