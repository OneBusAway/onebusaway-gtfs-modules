...
public interface HibernateOperations {
  ...
  public <T> List<T> findWithNamedParam(String queryString, String paramName, final Object value);

  public <T> List<T> findWithNamedParams(
      String queryString, String[] paramNames, final Object[] values);
  ...
  public <T> List<T> findByNamedQueryAndNamedParams(
      final String namedQuery, String[] paramNames, Object[] values);
