...
public class DuplicateScoringSupportTest {
  ...
  public void testScoreIntervalOverlap() {
    assertEquals(
        1.0,
        DuplicateScoringSupport.scoreIntervalOverlap(new int[] {0, 10}, new int[] {0, 10}),
        0.0);
    assertEquals(
        0.75,
        DuplicateScoringSupport.scoreIntervalOverlap(new int[] {0, 5}, new int[] {0, 10}),
        0.0);
    assertEquals(
        0.333,
        DuplicateScoringSupport.scoreIntervalOverlap(new int[] {0, 6}, new int[] {4, 10}),
        0.001);
    assertEquals(
        0.583,
        DuplicateScoringSupport.scoreIntervalOverlap(new int[] {0, 8}, new int[] {4, 10}),
        0.001);
    assertEquals(
        0.0,
        DuplicateScoringSupport.scoreIntervalOverlap(new int[] {0, 5}, new int[] {5, 10}),
        0.0);
  }
}
