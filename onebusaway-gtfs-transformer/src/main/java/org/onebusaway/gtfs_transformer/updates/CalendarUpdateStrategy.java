...
import org.onebusaway.gtfs_transformer.util.KingCountyMetroUpdateLibrary;
...
public class CalendarUpdateStrategy implements GtfsTransformStrategy {
    ...
    private Set<ServiceId> _serviceIds = new HashSet<ServiceId>();
    ...
    public AgencyAndId getServiceIdsForTrip(TransformContext context,
        ...
        ServiceId serviceId = new MetroKCServiceId(changeDates,
    ...
    private void computeServiceIdsForTrip(GtfsMutableDao dao, ServiceId key) {
