...
public class AddEntityTest extends AbstractTestSupport {
  ...
  public void test() throws IOException {
    ...
    addModification(
        "{'op':'add','obj':{'class':'Frequency','trip':'t0','startTime':'08:00:00','endTime':'10:00:00','headwaySecs':600}}");
    ...
    assertEquals(
        StopTimeFieldMappingFactory.getStringAsSeconds("08:00:00"), frequency.getStartTime());
    assertEquals(
        StopTimeFieldMappingFactory.getStringAsSeconds("10:00:00"), frequency.getEndTime());
