...
public class MockGtfs {
  ...
  private Map<String, String> _contentByFileName = new HashMap<String, String>();
  ...
  public void putFile(String fileName, String content) {
    _contentByFileName.put(fileName, content);
    updateZipFile();
  }
  ...
  private void updateZipFile() {
    try {
      ...
      for (Map.Entry<String, String> entry : _contentByFileName.entrySet()) {
