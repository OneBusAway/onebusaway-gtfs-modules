...
/**
 * Indicates that multiple {@link ServiceCalendar} entities, as loaded from calendars.txt, were
 * found with the same {@link ServiceCalendar#getServiceId()} value, a violation of the GTFS spec.
 *
 * @author bdferris
