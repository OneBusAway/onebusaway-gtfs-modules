...
public class AgencyAndId implements Serializable, Comparable<AgencyAndId> {
  ...
  public int compareTo(AgencyAndId o) {
    ...
    if (c == 0) c = this.id.compareTo(o.id);
    return c;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof AgencyAndId)) return false;
    AgencyAndId other = (AgencyAndId) obj;
    if (agencyId != null && !agencyId.equals(other.agencyId)) return false;
  ...
  /**
   * Given an id of the form "agencyId_entityId", parses into a {@link AgencyAndId} id object.
   *
  ...
  /**
   * Given an {@link AgencyAndId} object, creates a string representation of the form
   * "agencyId_entityId"
   *
