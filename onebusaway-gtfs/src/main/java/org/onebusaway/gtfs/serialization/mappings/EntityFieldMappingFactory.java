 ...
 * CSV string entity id to an entity instance, and vice versa. Assumes field entity type subclasses
 * {@link IdentityBean} and the target entity can be found with {@link
...
public class EntityFieldMappingFactory implements FieldMappingFactory {
  ...
  public FieldMapping createFieldMapping(
      ...
      Class<?> objFieldType,
      boolean required) {
    return new EntityFieldMappingImpl(
