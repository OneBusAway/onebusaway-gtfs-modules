...
/**
 * Responsible for setting the {@link Route#setAgency(Agency)} from a csv "agency_id" field in
 * "routes.txt" and vice-versa.
 *
 * @author bdferris
...
public class RouteAgencyFieldMappingFactory implements FieldMappingFactory {
  ...
  public FieldMapping createFieldMapping(
    ...
    return new RouteAgencyFieldMapping(
        entityType, csvFieldName, objFieldName, Agency.class, required);
  }

  private class RouteAgencyFieldMapping extends AbstractFieldMapping {

    public RouteAgencyFieldMapping(
        Class<?> entityType,
        String csvFieldName,
        String objFieldName,
        Class<?> objFieldType,
    ...
    public void translateFromCSVToObject(
      ...
      if (isMissing(csvValues)) {
        ...
        if (agencies.isEmpty()) {
          throw new AgencyNotFoundForRouteException(
              Route.class, object.getWrappedInstance(Route.class));
        ...
        if (agency == null)
          throw new AgencyNotFoundForRouteException(
              Route.class, object.getWrappedInstance(Route.class), agencyId);
      }
    ...
    public void translateFromObjectToCSV(
      ...
      if (isOptional() && agency == null) return;
