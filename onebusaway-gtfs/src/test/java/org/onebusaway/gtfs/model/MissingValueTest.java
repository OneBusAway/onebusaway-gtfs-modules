...
/**
 * Optional flex fields in stop times should not be present if not in use. As stop_times is one of
 * the biggest files, not only is it annoying it affects the overall GTFS size.
 */
public class MissingValueTest {
  ...
  public void test() throws IOException {
    ...
    _gtfs.putLines(
        ...
        "T10-0,100,0,,08:00:00,",
        "T10-0,200,1,05:55:55,09:00:00,");
  ...
  public void testStartingWithMissingValue() throws IOException {
    ...
    _gtfs.putLines(
        ...
        "T10-0,100,0,,08:00:00,-999",
        "T10-0,200,1,05:55:55,09:00:00,-999");
  ...
  /**
   * Non-proxied double fields have a quirk where the defaultValue needs to be -999.0 for the
   * string-based comparison to work.
   *
   * @throws IOException
   */
  @Test
  public void testStartingWithMissingDoubleValue() throws IOException {
    ...
    _gtfs.putLines(
        ...
        "T10-0,100,0,,08:00:00,-999,-999,-999,-999,-999,-999,-999,-999",
        "T10-0,200,1,05:55:55,09:00:00,-999,-999,-999,-999,-999,-999,-999,-999");
    ...
    assertFalse(foundShapeDist, "Not expecting shapeDistTraveled in line " + headerLine);
    assertFalse(
        foundStartServiceArea, "Not expecting start service area radius in line " + headerLine);
    assertFalse(foundEndServiceArea, "Not expecting end service area radius in line " + headerLine);
    assertFalse(
        foundMeanDurationFactor, "Not expecting mean duration factor in line " + headerLine);
    assertFalse(
        foundMeanDurationOffset, "Not expecting mean duration offset in line " + headerLine);
    assertFalse(
        foundSafeDurationFactor, "Not expecting safe duration factor in line " + headerLine);
    assertFalse(
        foundSafeDurationOffset, "Not expecting safe duration offset in line " + headerLine);
  }
